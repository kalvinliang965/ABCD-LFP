    ...
    tooltip: {
      ...
      formatter: function(params: any) {
       ...
       // tooltip += age ? `Year: ${year} / Age: ${age}</div>` : `Year: ${year}</div>`;
        ...
        const percentiles = [
          { name: 'P10-P90', lower: activeData.ranges.range10_90[0][yearIndex], upper: activeData.ranges.range10_90[1][yearIndex], color: 'rgba(173, 216, 230, 1)' },
          { name: 'P20-P80', lower: activeData.ranges.range20_80[0][yearIndex], upper: activeData.ranges.range20_80[1][yearIndex], color: 'rgba(100, 149, 237, 1)' },
          { name: 'P30-P70', lower: activeData.ranges.range30_70[0][yearIndex], upper: activeData.ranges.range30_70[1][yearIndex], color: 'rgba(70, 130, 180, 1)' },
          { name: 'P40-P60', lower: activeData.ranges.range40_60[0][yearIndex], upper: activeData.ranges.range40_60[1][yearIndex], color: 'rgba(25, 25, 112, 1)' }
        ];
      ...
      // First, the base line (10th percentile)
{
  ...
  // Then the fill (difference between 90th and 10th)
  {
    ...
    stack: 'confidence-band-10-90',
    data: activeData.ranges.range10_90[1].map((upper, i) => 
      upper - activeData.ranges.range10_90[0][i]
    )
  },
      ...
      // Base line at 20th percentile
{
  ...
  // Fill between 20th and 80th percentile
  {
    ...
    stack: 'confidence-band-20-80',
    data: activeData.ranges.range20_80[1].map((upper, i) => 
      upper - activeData.ranges.range20_80[0][i]
    )
  },
      ...
      // Base line at 30th percentile
{
  ...
  // Fill between 30th and 70th percentile
  {
    ...
    stack: 'confidence-band-30-70',
    data: activeData.ranges.range30_70[1].map((upper, i) =>
      upper - activeData.ranges.range30_70[0][i]
    )
  },  
      ...
      // Base line at 40th percentile
{
  ...
  // Fill between 40th and 60th percentile
  {
    ...
    stack: 'confidence-band-40-60',
    data: activeData.ranges.range40_60[1].map((upper, i) =>
      upper - activeData.ranges.range40_60[0][i]
    )
  }
  ,
  ...
  return (
    ...
    >
      ...
      <Text fontSize="sm" mt={2} color="gray.600" textAlign="center">
        This chart shows the median value and probability ranges for {getTitle().toLowerCase()}.
        The shaded regions represent different probability ranges: 10%-90% (lightest), 
        20%-80%, 30%-70%, and 40%-60% (darkest).
        {selectedQuantity === 'totalInvestments' && activeData.goal && 
