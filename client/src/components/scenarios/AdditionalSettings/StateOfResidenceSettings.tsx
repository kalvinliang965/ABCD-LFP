      ...
      <SimpleGrid columns={{ base: 1, md: 3 }} spacing={4}>
        {["NY", "NJ", "CT"].map((stateCode) => (
          <Box
            ...
            borderRadius="lg"
            borderColor={
              stateOfResidence === stateCode ? "blue.500" : "gray.200"
            }
            bg={stateOfResidence === stateCode ? "blue.50" : "transparent"}
            _hover={{ bg: "blue.50", borderColor: "blue.300" }}
            _dark={{
              borderColor:
                stateOfResidence === stateCode ? "blue.500" : "gray.600",
    ...
    >
      ...
      <CardBody p={6}>
        <Text fontSize="md" color="gray.600" mb={6}>
          Select your state of residence. This will be used for tax planning
          purposes and other state-specific financial considerations.
        </Text>
