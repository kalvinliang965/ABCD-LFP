...
import { Upload, ArrowLeft, FileUp, FilePlus, CheckCircle2 } from 'lucide-react';
...
const YamlImportForm: React.FC<YamlImportFormProps> = ({ onImportComplete, onBack }) => {
        ...
        <CardBody p={6}>
          <VStack spacing={8} align="stretch">
            <Text color="gray.600" fontSize="md">
              Upload a YAML file to import an existing scenario configuration. This will allow you
              to quickly set up your financial scenario without having to configure everything
              manually.
            </Text>
            ...
            {file && (
              ...
              >
                <Flex
                  ...
                  align="center"
                >
                  <Icon as={CheckCircle2} color="green.500" boxSize={6} mr={3} />
                  <Box flex="1">
