...
describe("IncomeEventSeriesForm", () => {
  ...
  it("fills the entire form and submits correct data", () => {
    ...
    const userPercentageInput = screen.getByText("User Percentage").closest("div")?.querySelector("input");
    const spousePercentageInput = screen.getByText("Spouse Percentage").closest("div")?.querySelector("input");
