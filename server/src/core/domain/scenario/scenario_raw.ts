...
import { ExpenseEventRaw, IncomeEventRaw, InvestmentRaw, RebalanceEventRaw } from "./Scenario";
import { 
    cash_investment_one, 
...
export const scenario_one = create_scenario_raw(
    ...
    new Set<IncomeEventRaw | InvestmentEventRaw | ExpenseEventRaw | RebalanceEventRaw>([
        salary_income_one,
        food_expense_one,
        vacation_expense_one,
        streaming_services_expense_one,
...
export function create_scenario_raw(
    ...
    eventSeries: Set<IncomeEventRaw | InvestmentEventRaw | ExpenseEventRaw | RebalanceEventRaw>,
