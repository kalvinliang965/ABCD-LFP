    ...
    return {
        update: async (simulation_state: SimulationState) => {
            ...
            const year_snapshot: YearResult = {
                ...
                cur_year_social_security: simulation_state.user_tax_data.get_cur_social_security(),
                cur_year_capital_gains: simulation_state.user_tax_data.get_cur_capital_gains(),
                cur_year_after_tax_contributions: simulation_state.user_tax_data.get_cur_after_tax_contribution(),
                cur_year_early_withdrawals: simulation_state.user_tax_data.get_cur_early_withdrawal(),
